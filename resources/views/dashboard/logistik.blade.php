...
<div class="container">
    <form method="post" id="data-form">
            ...
            <div class="col">
                ...
                <div class="form-group">
                    <label>Persediaan Buku   : </label>
                    <input name="persediaanBuku" type="text" class="form-control"/>
                </div>
                <div class="form-group">
                    <label>Tempat Penyimpanan   : </label>
                    <select name="tempat_penyimpanan" class="custom-select mr-sm-2" id="inlineFormCustomSelect">
