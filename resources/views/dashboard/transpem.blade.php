    ...
    <form method="post" id="data-form">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input name="noTransaksi" type="text" class="form-control"/>
                </div>
                <div class="form-group">
                    <label>No. Faktur Pembayaran :</label>
                    <input name="noFaktur" type="text" class="form-control"/>
                </div> 
                <div class="form-group">
            ...
            <div class="col">
                <div class="form-group">
                    <label>Perusahaan Buku  : </label>
                    <input name="perusahaanBuku" type="text" class="form-control"/>
                </div>
                <div class="form-group">
                    <label>Total Harga   : </label>
                    <input type="text" class="form-control" id="dengan-rupiah"/>
                    <input name="totalHarga" type="hidden" class="form-control" id="tanparupiah"/>
                </div>
                <div class="form-group">
